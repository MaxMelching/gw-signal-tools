...
def optimize_overlap(
    ...
    **inner_prod_kwargs
    ...
    opt_params : Optional[str | list[str]], optional, default = None
        ...
        `'psi'` (equivalent: `'phase'`). The latter two are essentially
        global time and phase shifts, they enter in the waveform as
    ...
    Returns
    -------
    tuple[FrequencySeries, FrequencySeries, dict[str, ~astropy.units.
    Quantity]]
    ...
    if opt_params is None:
        ...
        if len(_opt_params) == 2 and time_index is not None \
            ...
            # -> nope, just describe things properly in documentation
    ...
    if phase_index is not None:
        opt_params_results[opt_params[phase_index]] *= u.s
