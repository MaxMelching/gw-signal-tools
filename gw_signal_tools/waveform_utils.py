...
def get_signal_at_target_df(
    ...
    where speed matters and the metadata is not needed (for example in
    the inner product from :code:`~gw_signal_tools.inner_product`).
    """
...
def get_signal_at_target_frequs(
    ...
    fill_val : float | ~astropy.units.Quantity, optional, default = ~numpy.nan
...
def get_mass_scaled_wf(
    ...
    """
    Calculate and rescale a waveform so that is independent of the
    total mass.
